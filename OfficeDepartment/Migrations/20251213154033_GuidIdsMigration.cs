...
{
    /// <inheritdoc />
    public partial class GuidIdsMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchOfficeId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OfficeTasks_BranchOffices_BranchOfficeId",
                        column: x => x.BranchOfficeId,
                        principalTable: "BranchOffices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_OfficeTasks_Employees_AssignedEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfficeTasks_AssignedEmployeeId",
                table: "OfficeTasks",
                column: "AssignedEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_OfficeTasks_BranchOfficeId",
                table: "OfficeTasks",
                column: "BranchOfficeId");
